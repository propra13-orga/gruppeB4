...
{
	apply_Image(this->get_Position()->i_x - camera.x,this->get_Position()->i_y - camera.y,S_Resourcemanager::get_Resourcemanager()->get_Surface("Bär"),S_Resourcemanager::get_Resourcemanager()->get_Surface("Screen"));
	apply_Image(200 - camera.x,200 - camera.y,S_Resourcemanager::get_Resourcemanager()->get_Surface("Bär"),S_Resourcemanager::get_Resourcemanager()->get_Surface("Screen"));
