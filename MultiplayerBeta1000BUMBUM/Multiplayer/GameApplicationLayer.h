...
namespace MultiplayerHighClass
{
	...
	public:
		GameApplicationLayer():b_GameShutDown(false){p_GameUpdateSource = new MultiplayerLowClass::Update();}//Der Konstruktor der GameApplicationKlasse, er tut eigentlich nichts
